...
- [x] 03-03-PLAN.md — Unit + integration test suite for models, query_builder, and engine (RLVN-01..04)
...
- [x] 04-02-PLAN.md — ResultDelegate + _result_to_html + FilterSidebar with single-select groups + pytest-qt unit tests (SRCH-02, SRCH-04, UIPL-01)
...
**Wave 2** *(blocked on Wave 1)*:
- [x] 05-02-PLAN.md — nitrofind.spec + scripts/build_dist.py + manual clean-machine smoke test checkpoint (PKG-01)
